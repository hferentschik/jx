...
import (
	...
	"github.com/jenkins-x/jx/pkg/jx/cmd/cmd_delete"
	"github.com/jenkins-x/jx/pkg/jx/cmd/cmd_init"
	...
	cmd_import "github.com/jenkins-x/jx/pkg/jx/cmd/import"
...
func NewJXCommand(f clients.Factory, in terminal.FileReader, out terminal.FileWriter,
	...
	deleteCommands := cmd_delete.NewCmdDelete(commonOpts)
	...
	installCommands = append(installCommands, cmd_init.NewCmdInit(commonOpts))

	addProjectCommands := []*cobra.Command{
		cmd_import.NewCmdImport(commonOpts),
	}
