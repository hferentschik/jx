...
type InstallOptions struct {
	*opts.CommonOptions
	...
	InitOptions cmd_init.InitOptions
	Flags       InstallFlags
...
func NewCmdInstall(commonOpts *opts.CommonOptions) *cobra.Command {
	...
	cmd.Flags().StringVarP(&options.Flags.Provider, "provider", "", "", "Cloud service providing the Kubernetes cluster.  Supported providers: "+cmd_init.KubernetesProviderOptions())
