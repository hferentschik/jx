...
func NewCmdStepBDD(commonOpts *opts.CommonOptions) *cobra.Command {
	...
	cmd.Flags().StringVarP(&installOptions.Flags.Provider, "provider", "", "", "Cloud service providing the Kubernetes cluster.  Supported providers: "+cmd_init.KubernetesProviderOptions())
...
func (o *StepBDDOptions) deleteTeam(team string) error {
	...
	deleteTeam := &cmd_delete.DeleteTeamOptions{
